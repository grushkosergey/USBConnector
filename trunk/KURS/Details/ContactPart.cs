            ...
            if (Part != null)
            {
                ...
                if (entityContactSketch != null)
                {
                    ...
                    if (sketchDef != null)
                    {
                        ...
                        sketchEdit.ksLineSeg(data[Parametr.BodyWidth] - tolsh, tolsh, data[Parametr.BodyWidth] - tolsh, contactHeight, 1);
                        sketchEdit.ksLineSeg(data[Parametr.BodyWidth] - tolsh, contactHeight, tolsh, contactHeight, 1);
                        sketchEdit.ksLineSeg(tolsh, contactHeight, tolsh, tolsh, 1);
